...
func (aru *AuthRequestUpdate) SetUpdatedAt(t time.Time) *AuthRequestUpdate {
	aru.mutation.SetUpdatedAt(t)
	return aru
}

// SetNillableUpdatedAt sets the "updated_at" field if the given value is not nil.
func (aru *AuthRequestUpdate) SetNillableUpdatedAt(t *time.Time) *AuthRequestUpdate {
	if t != nil {
		aru.SetUpdatedAt(*t)
	}
	return aru
...
func (aru *AuthRequestUpdate) SetRequestID(u uuid.UUID) *AuthRequestUpdate {
	aru.mutation.SetRequestID(u)
	return aru
}
...
func (aru *AuthRequestUpdate) SetResponseType(s []string) *AuthRequestUpdate {
	aru.mutation.SetResponseType(s)
	return aru
}

// ClearResponseType clears the value of the "response_type" field.
func (aru *AuthRequestUpdate) ClearResponseType() *AuthRequestUpdate {
	aru.mutation.ClearResponseType()
	return aru
}
...
func (aru *AuthRequestUpdate) SetCodeChallengeMethod(acm authrequest.CodeChallengeMethod) *AuthRequestUpdate {
	aru.mutation.SetCodeChallengeMethod(acm)
	return aru
}

// SetNillableCodeChallengeMethod sets the "code_challenge_method" field if the given value is not nil.
func (aru *AuthRequestUpdate) SetNillableCodeChallengeMethod(acm *authrequest.CodeChallengeMethod) *AuthRequestUpdate {
	if acm != nil {
		aru.SetCodeChallengeMethod(*acm)
	}
	return aru
}
...
func (aru *AuthRequestUpdate) defaults() {
	if _, ok := aru.mutation.UpdateTime(); !ok {
		v := authrequest.UpdateDefaultUpdateTime()
...
func (aru *AuthRequestUpdate) check() error {
	if v, ok := aru.mutation.CodeChallengeMethod(); ok {
...
func (aru *AuthRequestUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := aru.mutation.RequestID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
	...
	if value, ok := aru.mutation.ResponseType(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeJSON,
			Value:  value,
	...
	if aru.mutation.ResponseTypeCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeJSON,
			Column: authrequest.FieldResponseType,
		})
...
// SetUpdatedAt sets the "updated_at" field.
func (aruo *AuthRequestUpdateOne) SetUpdatedAt(t time.Time) *AuthRequestUpdateOne {
	aruo.mutation.SetUpdatedAt(t)
	return aruo
}

// SetNillableUpdatedAt sets the "updated_at" field if the given value is not nil.
func (aruo *AuthRequestUpdateOne) SetNillableUpdatedAt(t *time.Time) *AuthRequestUpdateOne {
	if t != nil {
		aruo.SetUpdatedAt(*t)
	}
	return aruo
...
// SetRequestID sets the "request_id" field.
func (aruo *AuthRequestUpdateOne) SetRequestID(u uuid.UUID) *AuthRequestUpdateOne {
	aruo.mutation.SetRequestID(u)
	return aruo
}
...
// SetResponseType sets the "response_type" field.
func (aruo *AuthRequestUpdateOne) SetResponseType(s []string) *AuthRequestUpdateOne {
	aruo.mutation.SetResponseType(s)
	return aruo
}

// ClearResponseType clears the value of the "response_type" field.
func (aruo *AuthRequestUpdateOne) ClearResponseType() *AuthRequestUpdateOne {
	aruo.mutation.ClearResponseType()
	return aruo
}
...
// SetCodeChallengeMethod sets the "code_challenge_method" field.
func (aruo *AuthRequestUpdateOne) SetCodeChallengeMethod(acm authrequest.CodeChallengeMethod) *AuthRequestUpdateOne {
	aruo.mutation.SetCodeChallengeMethod(acm)
	return aruo
}

// SetNillableCodeChallengeMethod sets the "code_challenge_method" field if the given value is not nil.
func (aruo *AuthRequestUpdateOne) SetNillableCodeChallengeMethod(acm *authrequest.CodeChallengeMethod) *AuthRequestUpdateOne {
	if acm != nil {
		aruo.SetCodeChallengeMethod(*acm)
	}
	return aruo
}
...
// defaults sets the default values of the builder before save.
func (aruo *AuthRequestUpdateOne) defaults() {
...
func (aruo *AuthRequestUpdateOne) check() error {
	if v, ok := aruo.mutation.CodeChallengeMethod(); ok {
		if err := authrequest.CodeChallengeMethodValidator(v); err != nil {
			return &ValidationError{Name: "code_challenge_method", err: fmt.Errorf("ent: validator failed for field \"code_challenge_method\": %w", err)}
		}
	}
...
func (aruo *AuthRequestUpdateOne) sqlSave(ctx context.Context) (_node *AuthRequest, err error) {
	...
	if value, ok := aruo.mutation.RequestID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
			Column: authrequest.FieldRequestID,
	...
	if value, ok := aruo.mutation.ResponseType(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeJSON,
			Value:  value,
			Column: authrequest.FieldResponseType,
	...
	if aruo.mutation.ResponseTypeCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeJSON,
			Column: authrequest.FieldResponseType,
		})
