...
//		GroupBy(authcode.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
...
//
//	client.AuthCode.Query().
//		Select(authcode.FieldCreatedAt).
//		Scan(ctx, &v)
//
...
func (acgb *AuthCodeGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(acgb.fields) > 1 {
		return nil, errors.New("ent: AuthCodeGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := acgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (acgb *AuthCodeGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{authcode.Label}
	default:
		err = fmt.Errorf("ent: AuthCodeGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (acgb *AuthCodeGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(acgb.fields) > 1 {
		return nil, errors.New("ent: AuthCodeGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := acgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (acgb *AuthCodeGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{authcode.Label}
	default:
		err = fmt.Errorf("ent: AuthCodeGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (acgb *AuthCodeGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(acgb.fields) > 1 {
		return nil, errors.New("ent: AuthCodeGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := acgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (acgb *AuthCodeGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{authcode.Label}
	default:
		err = fmt.Errorf("ent: AuthCodeGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (acgb *AuthCodeGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(acgb.fields) > 1 {
		return nil, errors.New("ent: AuthCodeGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := acgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (acgb *AuthCodeGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{authcode.Label}
	default:
		err = fmt.Errorf("ent: AuthCodeGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (acs *AuthCodeSelect) Strings(ctx context.Context) ([]string, error) {
	if len(acs.fields) > 1 {
		return nil, errors.New("ent: AuthCodeSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := acs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (acs *AuthCodeSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{authcode.Label}
	default:
		err = fmt.Errorf("ent: AuthCodeSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (acs *AuthCodeSelect) Ints(ctx context.Context) ([]int, error) {
	if len(acs.fields) > 1 {
		return nil, errors.New("ent: AuthCodeSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := acs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (acs *AuthCodeSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{authcode.Label}
	default:
		err = fmt.Errorf("ent: AuthCodeSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (acs *AuthCodeSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(acs.fields) > 1 {
		return nil, errors.New("ent: AuthCodeSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := acs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (acs *AuthCodeSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{authcode.Label}
	default:
		err = fmt.Errorf("ent: AuthCodeSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (acs *AuthCodeSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(acs.fields) > 1 {
		return nil, errors.New("ent: AuthCodeSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := acs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (acs *AuthCodeSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{authcode.Label}
	default:
		err = fmt.Errorf("ent: AuthCodeSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
